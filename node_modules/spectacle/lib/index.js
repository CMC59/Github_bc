...
var FlexBox = import_styled_components4.default.div(
...
var Grid = import_styled_components4.default.div(
  (0, import_styled_system.compose)(import_styled_system.layout, import_styled_system.grid, import_styled_system.position),
  containerPrintStyle
);
Grid.defaultProps = {
  display: "grid"
...
var Text = import_styled_components5.default.div(
  (0, import_styled_system2.compose)(import_styled_system2.color, import_styled_system2.typography, import_styled_system2.space)
);
Text.defaultProps = {
  color: "primary",
  fontFamily: "text",
...
var CodeSpan = import_styled_components5.default.code(
  (0, import_styled_system2.compose)(import_styled_system2.color, import_styled_system2.typography, import_styled_system2.space)
);
...
var Link = import_styled_components5.default.a(
...
var Heading = (0, import_styled_components5.default)(Text)({});
...
var OrderedList = import_styled_components5.default.ol(
...
var UnorderedList = import_styled_components5.default.ul(
  (0, import_styled_system2.compose)(import_styled_system2.color, import_styled_system2.typography, import_styled_system2.space, listStyle)
);
...
var ListItem = import_styled_components5.default.li(
  (0, import_styled_system2.compose)(import_styled_system2.color, import_styled_system2.typography, import_styled_system2.space)
);
...
var useTimer = (handler, period, isActive) => {
  const [timeDelay, setTimeDelay] = (0, import_react10.useState)(1);
  const initialTime = (0, import_react10.useRef)();
  const callBack = (0, import_react10.useRef)();
...
var Timer = () => {
  const [timer, setTimer] = (0, import_react11.useState)(0);
  const [timerStarted, setTimerStarted] = (0, import_react11.useState)(false);
  const addToTimer = (0, import_react11.useCallback)((v) => setTimer((s) => s + v), []);
  const toggleTimer = (0, import_react11.useCallback)(() => setTimerStarted((s) => !s), []);
  const resetTimer = (0, import_react11.useCallback)(() => setTimer(0), []);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(FlexBox, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(FlexBox, { justifyContent: "flex-start", flex: 1, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      Text,
      {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(internal_button_default, { onClick: toggleTimer, children: timerStarted ? "Stop Timer" : "Start Timer" }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box, { width: 8 }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(internal_button_default, { onClick: resetTimer, children: "Reset" })
  ] });
};
...
var PresenterMode = (props) => {
  ...
  const deck = (0, import_react12.useRef)(null);
  const previewDeck = (0, import_react12.useRef)(null);
  const [notePortalNode, setNotePortalNode] = (0, import_react12.useState)();
  const [showFinalSlide, setShowFinalSlide] = (0, import_react12.useState)(true);
  const [postMessage] = useBroadcastChannel(
    "spectacle_presenter_bus",
    (message) => {
  ...
  const onActiveStateChange = (0, import_react12.useCallback)(
    (activeView) => {
      var _a, _b;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(PresenterDeckContainer, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(NotesColumn, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(FlexBox, { justifyContent: "space-between", paddingTop: 15, paddingX: 15, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(SpectacleLogo, { size: 60 }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(FlexBox, { width: 0.75, flexDirection: "column", alignItems: "flex-end", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          Text,
          {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Box, { paddingX: 15, paddingY: 10, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Timer, {}) }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(NotesContainer, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        Text,
        {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(PreviewColumn, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(PreviewSlideWrapper, { visible: showFinalSlide, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        DeckInternal,
        {
...
function useSteps(numSteps = 1, {
  ...
  const [stepId] = (0, import_react13.useState)(userProvidedId || id);
  const slideContext = (0, import_react13.useContext)(SlideContext);
  ...
  return {
    ...
    isActive,
    step: relStep,
    placeholder: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", __spreadValues({}, placeholderProps))
  };
}
function useCollectSteps() {
  const [stepContainer, setStepContainer] = (0, import_react13.useState)();
  const [activationThresholds, setActivationThresholds] = (0, import_react13.useState)({});
  const [finalStepIndex, setFinalStepIndex] = (0, import_react13.useState)(0);
  (0, import_react13.useEffect)(() => {
    if (!stepContainer)
      return;
...
// src/components/slide/slide.tsx
var import_react_swipeable = require("react-swipeable");
var import_jsx_runtime7 = require("react/jsx-runtime");
var noop3 = () => {
};
var SlideContext = (0, import_react14.createContext)(null);
SlideContext.displayName = "SlideContext";
var SlideContainer2 = import_styled_components8.default.div`
...
`;
var SlideWrapper2 = import_styled_components8.default.div(
  import_styled_system3.color,
...
var AnimatedDiv = (0, import_styled_components8.default)(import_react_spring.animated.div)`
  width: 100%;
  height: 100%;
  position: absolute;
  background: transparent;

  ${({ tabIndex }) => tabIndex === 0 && import_styled_components8.css`
...
var Slide = (props) => {
  ...
  if ((0, import_react14.useContext)(SlideContext)) {
  ...
  const {
    ...
    inOverviewMode,
    inPrintMode
  } = (0, import_react14.useContext)(DeckContext);
  ...
  const mergedTransition = (0, import_react14.useMemo)(() => {
  ...
  const [animate, setAnimate] = (0, import_react14.useState)(false);
  ...
  const onHoverChange = (0, import_react14.useCallback)(() => {
    setHover(!hover);
  }, [hover]);
  ...
  const target = (0, import_react14.useMemo)(() => {
    if (isPassed) {
  ...
  const springFrameStyle = (0, import_react_spring.useSpring)({
    to: target,
    immediate
  });
  const theme = (0, import_react14.useContext)(import_styled_components8.ThemeContext);
  const scaledWrapperOverrideStyle = (0, import_react14.useMemo)(() => {
    var _a;
  ...
  const swipeHandler = (0, import_react_swipeable.useSwipeable)({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
      SlideContext.Provider,
      {
        ...
        children: slidePortalNode && import_react_dom.default.createPortal(
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
            AnimatedDiv,
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
                ...
                __spreadProps(__spreadValues({
                  ...
                  children: [
                    (slideHasTemplate && isActive || inOverviewMode || inPrintMode) && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(template_wrapper_default, { style: wrapperOverrideStyle, children: templateElement }),
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                      SlideWrapper2,
                      {
...
var Backdrop = import_styled_components9.default.div`
  background-color: white;
`;
var PrintStyle = import_styled_components9.createGlobalStyle`
  @media print {
    body, html {
      margin: 0;
    }
...
function PrintMode({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(PrintStyle, { pageSize: computedPageSize }),
...
var import_query_string3 = require("query-string");
var useModes = () => {
  var _a, _b;
  const qs = ((_b = (_a = typeof window !== "undefined" ? window : {}) == null ? void 0 : _a.location) == null ? void 0 : _b.search) || "";
  const mode = (0, import_react15.useRef)(
    modeKeyForSearchParam(
      (0, import_query_string3.parse)(qs, {
        parseBooleans: true
      })
    )
  );
  const toggleMode = (0, import_react15.useCallback)(
    (args) => {
      const { newMode, senderSlideIndex, e } = args;
      e == null ? void 0 : e.preventDefault();
      let stepIndex = 0;
      let slideIndex = senderSlideIndex || "";
      const searchParams = (0, import_query_string3.parse)(window.location.search, {
        parseBooleans: true
      });
      if (!slideIndex) {
      ...
      if (mode.current === newMode) {
        window.location.search = (0, import_query_string3.stringify)({
          slideIndex,
          stepIndex
        });
        return;
      ...
      window.location.search = (0, import_query_string3.stringify)(__spreadValues({
        slideIndex,
        stepIndex
  ...
  const getCurrentMode = (0, import_react15.useCallback)(() => mode.current, []);
...
var ResultCommand = import_styled_components10.default.div`
  display: flex;
  ...
  height: 30px;
`;
var ResultSectionHeader = (0, import_styled_components10.default)(Text)`
  background-color: white;
  color: gray;
  margin: 0 2rem;
  padding: 0.5rem 0;
  ...
  font-family: ${SYSTEM_FONT};
`;
var ResultShortcut = import_styled_components10.default.span`
  display: flex;
  gap: 5px;
`;
var ResultShortcutKey = import_styled_components10.default.kbd`
  display: flex;
...
function onRender({ item, active }) {
  if (typeof item === "string") {
    return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(ResultSectionHeader, { children: item });
  } else {
    return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(ResultCommand, { active, children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Text, { fontFamily: SYSTEM_FONT, children: item.name }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(ResultShortcut, { children: getShortcutKeys(item).map(
        (key) => key && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(ResultShortcutKey, { children: key }, `${item.id}-${key}`)
      ) })
    ] });
  }
}
var CommandBarResults = () => {
  const { results } = (0, import_kbar3.useMatches)();
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(import_kbar3.KBarResults, { items: results, onRender });
};
var results_default = CommandBarResults;

// src/components/command-bar/search/index.tsx
var import_jsx_runtime10 = require("react/jsx-runtime");
var KBarSearchStyled = (0, import_styled_components11.default)(import_kbar4.KBarSearch)`
  padding: 12px 16px;
  font-size: 16px;
  width: 100%;
  ...
  border: none;
`;
var KBarAnimatorStyled = (0, import_styled_components11.default)(import_kbar4.KBarAnimator)`
  max-width: 600px;
  width: 100%;
  background: white;
  border-radius: 8px;
...
var CommandBarSearch = () => {
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_kbar4.KBarPortal, { children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_kbar4.KBarPositioner, { children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(KBarAnimatorStyled, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(KBarSearchStyled, {}),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(results_default, {})
  ] }) }) });
};
...
var CommandBar = ({ children }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(import_kbar5.KBarProvider, { actions, children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(search_default, {}),
    children
  ] });
};
...
var View = (_a) => {
  ...
  switch (mode) {
    case SPECTACLE_MODES.DEFAULT_MODE:
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(default_deck_default, __spreadProps(__spreadValues({}, props), { toggleMode }));
    case SPECTACLE_MODES.PRESENTER_MODE:
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(presenter_mode_default, __spreadValues({}, props));
    case SPECTACLE_MODES.PRINT_MODE:
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(PrintMode, __spreadValues({}, props));
    case SPECTACLE_MODES.EXPORT_MODE:
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(PrintMode, __spreadProps(__spreadValues({}, props), { exportMode: true }));
    case SPECTACLE_MODES.OVERVIEW_MODE:
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(default_deck_default, __spreadValues({ overviewMode: true, toggleMode }, props));
    default:
...
var SpectacleDeck = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(command_bar_default, { children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
    View,
    __spreadValues({
      getCurrentMode,
      toggleMode
...
var SteppedComponent = (props) => {
  ...
  const slideContext = (0, import_react17.useContext)(SlideContext);
  const { inPrintMode, inOverviewMode } = (0, import_react17.useContext)(DeckContext);
  if (slideContext === null) {
    throw new Error(
  ...
  const AnimatedEl = import_react_spring2.animated[tagName];
  let children;
  ...
  const springStyle = (0, import_react_spring2.useSpring)({
...
var Appear = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(SteppedComponent, __spreadProps(__spreadValues({}, restProps), { numSteps: 1, children }));
};
var Stepper = (props) => {
  const _a = props, {
    values,
...
var import_vs_dark = __toESM(require("react-syntax-highlighter/dist/cjs/styles/prism/vs-dark.js"));
var allThemes = __toESM(require("react-syntax-highlighter/dist/cjs/styles/prism/index.js"));
var import_jsx_runtime14 = require("react/jsx-runtime");
var vsDarkTheme = import_vs_dark.default.default || import_vs_dark.default;
...
var Container = (0, import_styled_components12.default)("div")((0, import_styled_system4.compose)(import_styled_system4.position, import_styled_system4.layout));
var CodePane = (0, import_react18.forwardRef)(
  (_a, ref) => {
    var _b = _a, {
      highlightRanges = [],
      language,
    ...
    const numberOfSteps = (0, import_react18.useMemo)(() => {
    ...
    const theme = (0, import_react18.useContext)(import_styled_components12.ThemeContext);
    ...
    const scrollTarget = (0, import_react18.useRef)(null);
    const getLineNumberStyle = (0, import_react18.useCallback)(
      (lineNumber) => {
        if (!isActive)
          return {};
    ...
    const getLineProps = (0, import_react18.useCallback)(
      (lineNumber) => {
        if (!isActive)
          return {};
        const range = getRangeFormat(numberOfSteps, highlightRanges, step);
    ...
    const customStyle = (0, import_react18.useMemo)(() => {
      const {
        space: space5 = [0, 0, 0],
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [
      placeholder,
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(Container, __spreadProps(__spreadValues({ ref }, props), { children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
...
var Table = import_styled_components13.default.table(
  (0, import_styled_system5.compose)(import_styled_system5.color, import_styled_system5.typography, import_styled_system5.space, import_styled_system5.border, import_styled_system5.layout)
);
Table.defaultProps = {
  color: "primary",
  fontFamily: "text",
...
var TableHeader = import_styled_components13.default.thead(
  (0, import_styled_system5.compose)(import_styled_system5.color, import_styled_system5.typography, import_styled_system5.space, import_styled_system5.border, import_styled_system5.layout)
);
...
var TableBody = import_styled_components13.default.tbody(
  (0, import_styled_system5.compose)(import_styled_system5.color, import_styled_system5.typography, import_styled_system5.space, import_styled_system5.border, import_styled_system5.layout)
);
...
var TableRow = import_styled_components13.default.tr(
  (0, import_styled_system5.compose)(import_styled_system5.color, import_styled_system5.typography, import_styled_system5.space, import_styled_system5.border, import_styled_system5.layout)
);
...
var TableCell = import_styled_components13.default.td(
  (0, import_styled_system5.compose)(import_styled_system5.color, import_styled_system5.typography, import_styled_system5.space, import_styled_system5.border, import_styled_system5.layout)
);
...
var Image = import_styled_components14.default.img((0, import_styled_system6.compose)(import_styled_system6.layout, import_styled_system6.position));
var FullSizeImage = (0, import_styled_components14.default)(Image);
...
var Notes = ({ children }) => {
  const { notePortalNode } = (0, import_react19.useContext)(DeckContext);
  const { isSlideActive } = (0, import_react19.useContext)(SlideContext);
  if (!isSlideActive)
    return null;
  if (!notePortalNode)
    return null;
  return import_react_dom2.default.createPortal(/* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { children }), notePortalNode);
};
...
var Circle = import_styled_components15.default.div`
  width: ${({ size }) => size}px;
  height: ${({ size }) => size}px;
  ...
  cursor: pointer;
`;
var ProgressContainer = import_styled_components15.default.div`
  ${import_styled_system7.position}
  display: flex;
  flex-wrap: wrap;
  @media print {
    display: none;
...
`;
var Progress = (0, import_react20.forwardRef)(
  (_a, ref) => {
    var _b = _a, { color: color5 = "#fff", size = DEFAULT_PROGRESS_CIRCLE_SIZE } = _b, props = __objRest(_b, ["color", "size"]);
    const { slideCount, skipTo, activeView } = (0, import_react20.useContext)(DeckContext);
    return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
      ...
      __spreadProps(__spreadValues({
        ...
        children: Array(slideCount).fill(0).map((_, idx) => /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
          Circle,
          {
            color: color5,
...
var PacmanBase = import_styled_components16.default.div`
  position: absolute;
  top: ${({ top }) => top}px;
  left: ${({ left }) => left}px;
...
`;
var pacmanTopFrames = import_styled_components16.keyframes`
  0% { transform: rotateZ(0deg) }
  100% { transform: rotateZ(-30deg) }
`;
var pacmanBottomFrames = import_styled_components16.keyframes`
  0% { transform: rotateZ(0deg) }
  100% { transform: rotateZ(30deg) }
`;
var pacmanTopFramesAlternate = import_styled_components16.keyframes`
  0% { transform: rotateZ(0.1deg) }
  100% { transform: rotateZ(-30deg) }
`;
var pacmanBottomFramesAlternate = import_styled_components16.keyframes`
  0% { transform: rotateZ(0.1deg) }
  100% { transform: rotateZ(30deg) }
`;
var PacmanBodyTop = import_styled_components16.default.div`
  position: absolute;
  top: 0;
...
`;
var PacmanBodyBottom = (0, import_styled_components16.default)(PacmanBodyTop)`
  top: 50%;
...
var AnimatedProgress = (0, import_react21.forwardRef)(
  (_a, ref) => {
    var _b = _a, {
    ...
    const {
      ...
      skipTo,
      activeView: { slideIndex }
    } = (0, import_react21.useContext)(DeckContext);
    const [pacmanOffsetLeft, setPacmanOffsetLeft] = (0, import_react21.useState)(
      null
    );
    const [pacmanOffsetTop, setPacmanOffsetTop] = (0, import_react21.useState)(null);
    const [alternateAnimation, setAlternateAnimation] = (0, import_react21.useState)(false);
    const [activeCircleNode, setActiveCircleNode] = (0, import_react21.useState)(null);
    const activeCircleCallbackRef = (0, import_react21.useCallback)(
      (activeCircleNode2) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(ProgressContainer, __spreadProps(__spreadValues({ ref, position: "relative" }, props), { children: [
      typeof pacmanOffsetTop === "number" && typeof pacmanOffsetLeft === "number" && /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(
        PacmanBase,
        {
          pacmanSize,
          top: pacmanOffsetTop,
      ...
      Array(slideCount).fill(0).map((_, idx) => /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
        Circle,
        {
...
var useToggleFullScreen = () => (0, import_react22.useCallback)(() => {
...
var Container2 = (0, import_styled_components17.default)("div")`
  ${import_styled_system8.position}
  @media print {
    display: none;
  }
`;
var FullScreen = (0, import_react23.forwardRef)(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
      ...
      __spreadProps(__spreadValues({
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("svg", { width: size, height: size, viewBox: "0 0 512 512", children: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
          "path",
          {
            fill: color5,
...
var Full = (_a) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(slide_default, __spreadProps(__spreadValues({}, rest), { children }));
};
var Center = (_a) => {
  var _b = _a, { children } = _b, rest = __objRest(_b, ["children"]);
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(slide_default, __spreadProps(__spreadValues({}, rest), { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(FlexBox, { justifyContent: "center", alignItems: "center", height: "100%", children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Box, { children }) }) }));
};
var TwoColumn = (_a) => {
  var _b = _a, {
    left,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(slide_default, __spreadProps(__spreadValues({}, rest), { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(FlexBox, { flexDirection: "row", alignItems: "start", flex: 1, children: [
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Box, { width: "100%", children: left }),
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Box, { width: "100%", children: right })
  ] }) }));
};
var Ul = ({
  items = [],
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(List2, __spreadProps(__spreadValues({}, listProps), { children: items.map((item, i) => {
    const Wrapper = animate ? Appear : import_react24.Fragment;
    return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Wrapper, { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(ListItem, { children: item }, i) }, i);
  }) }));
};
var List = (_a) => {
  var _b = _a, {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(slide_default, __spreadProps(__spreadValues({}, rest), { children: [
    title ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Heading, __spreadProps(__spreadValues({ textAlign: "left" }, titleProps), { children: title })) : null,
...
var Header = (_a) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(slide_default, __spreadProps(__spreadValues({}, rest), { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(FlexBox, __spreadProps(__spreadValues({ height: "100%" }, flexBoxProps), { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Heading, __spreadProps(__spreadValues({}, headingProps), { children })) })) }));
};
var Section = ({
  sectionProps,
  children
...
var Statement = ({
  statementProps,
  children
}) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Header, { headingProps: statementProps, children });
var BigFact = (_a) => {
  var _b = _a, {
    children,
    factInformation,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(slide_default, __spreadProps(__spreadValues({}, rest), { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(FlexBox, { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(Box, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Text, __spreadProps(__spreadValues({ textAlign: "center", fontSize: factFontSize }, factProps), { children })),
    factInformation ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Text, __spreadProps(__spreadValues({ textAlign: "center" }, factInformationProps), { children: factInformation })) : null
  ] }) }) }));
};
var Quote2 = (_a) => {
  var _b = _a, {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(slide_default, __spreadProps(__spreadValues({}, rest), { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(Box, { width: "100%", margin: "auto", children: [
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Text, __spreadProps(__spreadValues({ fontSize: "85px" }, quoteProps), { children })),
    /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(Text, __spreadProps(__spreadValues({ fontSize: "36px", padding: "0em 0em 0em 1em" }, attributionProps), { children: [
      "\u2013",
      attribution
    ] }))
  ] }) }));
...
var CodeLayout = (_a) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(Box, { "data-testid": "CodePane", children: [
    text3 ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Text, __spreadProps(__spreadValues({ margin: 8 }, textProps), { children: text3 })) : null,
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(code_pane_default, __spreadProps(__spreadValues({}, props), { children }))
  ] });
};
var Code = (_a) => {
  var _b = _a, {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(slide_default, __spreadProps(__spreadValues({}, rest), { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(Box, { display: "inline-block", style: { overflow: "scroll" }, children: [
    title ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Heading, __spreadProps(__spreadValues({}, titleProps), { children: title })) : null,
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(CodeLayout, __spreadProps(__spreadValues({ language }, codePaneProps), { children }))
  ] }) }));
};
...
var Img = import_styled_components18.default.img`
  min-width: 100%;
  min-height: 100%;
  max-width: 100%;
  object-fit: ${(props) => props.objectFit || "contain"};
`;
var ImgContainer = (0, import_styled_components18.default)(FlexBox)`
  overflow: hidden;
`;
var Image2 = ({
  src,
  ...
  imgProps,
  objectFit
}) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(ImgContainer, __spreadProps(__spreadValues({ "data-testid": "ImgContainer" }, imgContainerProps), { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
  Img,
  __spreadValues({
    "data-testid": "Img",
    src,
...
var HorizontalImage = (_a) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(slide_default, __spreadProps(__spreadValues({}, rest), { children: [
    ...
    title ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Heading, __spreadProps(__spreadValues({ textAlign: "left", margin: "0 0" }, titleProps), { children: title })) : null,
    description ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Text, __spreadProps(__spreadValues({ margin: "0 0" }, descriptionProps), { children: description })) : null
  ] }));
};
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(slide_default, __spreadProps(__spreadValues({}, rest), { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
      Grid,
      {
        ...
        height: "100%",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(FlexBox, { justifyContent: "start", children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
            Ul,
            __spreadValues({
              items: listItems,
              animate: animateListItems,
...
var ThreeUpImage = (_a) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(slide_default, __spreadProps(__spreadValues({}, rest), { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
    Grid,
    {
      height: "100%",
      gridColumnGap: 2,
      gridTemplateColumns: "repeat(2, 1fr)",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(Grid, { gridRowGap: 2, gridTemplateRows: "repeat(2, .5fr)", children: [
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
            Image2,
            {
              src: top.src,
...
var FullBleedImage = (_a) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(slide_default, __spreadProps(__spreadValues({ padding: "0 0 0" }, rest), { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
    Image2,
    {
      src,
      alt,
...
var DefaultTemplate = ({ color: color5 = "#fff" }) => /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
  FlexBox,
  {
    ...
    width: 1,
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Box, { padding: "0 1em", children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(fullscreen_default, { color: color5 }) }),
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Box, { padding: "1em", children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(animated_progress_default, { color: color5 }) })
    ]
  }
);

// src/utils/remark-rehype-presenter-notes.ts
var import_mdast_zone = __toESM(require("mdast-zone"));
var import_unist_util_visit = __toESM(require("unist-util-visit"));
var mdast = __toESM(require("mdast-builder"));
function remarkRehypePresenterNotes(noteCallback) {
  ...
  return (tree) => {
    (0, import_mdast_zone.default)(tree, "notes", transformZoneNote);
    (0, import_unist_util_visit.default)(tree, "paragraph", transformLineNote);
  };
}
...
var import_mdast_builder = require("mdast-builder");

// src/utils/mdx-component-mapper.tsx
var import_jsx_runtime21 = require("react/jsx-runtime");
var mdxComponentMap = {
  p: Text,
  h1: (props) => /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Heading, __spreadProps(__spreadValues({}, props), { fontSize: "h1" })),
  h2: (props) => /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Heading, __spreadProps(__spreadValues({}, props), { fontSize: "h2" })),
  h3: (props) => /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Heading, __spreadProps(__spreadValues({}, props), { fontSize: "h3" })),
  h4: (props) => /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Heading, __spreadProps(__spreadValues({}, props), { fontSize: "h4" })),
  blockquote: Quote,
  ul: UnorderedList,
  ol: OrderedList,
  li: ListItem,
...
var Columns = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(FlexBox, { flexDirection: "row", alignItems: "start", flex: 1, children });
var Center2 = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(FlexBox, { justifyContent: "center", alignItems: "center", height: "100%", children });
...
var MarkdownSlide = (_a) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(slide_default, __spreadProps(__spreadValues({}, rest), { children: /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
    Markdown,
    __spreadValues({}, {
      componentMap,
      template,
...
var import_unist_util_visit2 = __toESM(require("unist-util-visit"));
var mdast2 = __toESM(require("mdast-builder"));
var import_unist_util_visit3 = __toESM(require("unist-util-visit"));
var import_lodash = __toESM(require("lodash.clonedeep"));
var directiveNodeTypes = ["sectionDirective"];
var directiveMatch = /^::(.*)$/;
var cloneFn = typeof structuredClone !== "undefined" ? structuredClone : import_lodash.default;
var directiveParserPlugin = () => {
  ...
  return (tree) => {
    (0, import_unist_util_visit2.default)(tree, "paragraph", transformLineDirective);
  };
};
var directivesHandlerPlugin = () => {
  return (tree) => {
    ...
    (0, import_unist_util_visit3.default)(tree, (node) => {
...
var Container3 = (0, import_styled_components19.default)("div")((0, import_styled_system9.compose)(import_styled_system9.position, import_styled_system9.layout), { height: "100%" });
var Markdown = (0, import_react25.forwardRef)(
  (_a, ref) => {
    var _b = _a, {
    ...
    const { theme: { markdownComponentMap: themeComponentMap = null } = {} } = (0, import_react25.useContext)(DeckContext);
    const [templateProps, noteElements] = (0, import_react25.useMemo)(() => {
      const markdownText = indent_normalizer_default(rawMarkdownText);
      const ast = (0, import_unified.default)().use(import_remark_parse.default).parse(markdownText);
      const extractedNotes = (0, import_mdast_builder.root)();
      const transformedAst = (0, import_unified.default)().use(remarkRehypePresenterNotes, (...notes) => {
        ...
        newMap[key] = (props2) => {
          ...
          const children2 = key === "p" ? (_a3 = props2.children) == null ? void 0 : _a3.map((child) => {
            if (typeof child == "string") {
              ...
              return lines.map((str, i) => /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(import_react25.default.Fragment, { children: [
                str,
                i !== lines.length - 1 && /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("br", {})
              ] }, i));
            }
            return child;
          }) : props2.children;
          return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Component, __spreadProps(__spreadValues(__spreadValues({}, props2), componentProps || {}), { children: children2 }));
        };
        return newMap;
      }, {});
      const compiler = (0, import_unified.default)().use(import_remark_rehype.default, { allowDangerousHtml: true }).use(import_rehype_raw.default).use(import_rehype_react.default, {
        createElement: import_react25.createElement,
      ...
      const notesCompiler = (0, import_unified.default)().use(import_remark_rehype.default, { allowDangerousHtml: true }).use(import_rehype_raw.default).use(import_rehype_react.default, {
        createElement: import_react25.createElement,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Container3, __spreadProps(__spreadValues({ ref }, props), { children: /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(TemplateComponent, __spreadProps(__spreadValues({}, restProps), { children: [
      (slideConfig == null ? void 0 : slideConfig.layout) === "columns" ? children.props.children : children,
      noteElements
    ] })) }));
  }
);
var AppearingListItem = (props) => /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Appear, { children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(ListItem, __spreadValues({}, props)) });
var MarkdownSlideSet = (_a) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(import_jsx_runtime24.Fragment, { children: mdSlides.map((md, ix) => {
    const props = {};
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(MarkdownSlide, __spreadProps(__spreadValues({ slideConfig: jsonObject }, props), { children: content }), ix);
  }) });
};
var MarkdownPreHelper = (PreComponent = "pre", CodeInlineComponent = "code", CodeBlockComponent) => (_a) => {
  ...
  const pre = /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(PreComponent, __spreadProps(__spreadValues({}, restProps), { children }));
  if (import_react25.Children.count(children) !== 1)
    return pre;
  const child = children[0];
  if (child.type !== CodeInlineComponent)
    return pre;
  if (!(0, import_react_is.isValidElementType)(CodeBlockComponent))
    return pre;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(CodeBlockComponent, __spreadProps(__spreadValues(__spreadValues({}, restProps), restChildProps), { children: rawCode }));
};
var MarkdownCodePane = (_a) => {
  ...
  const language = (0, import_react25.useMemo)(() => {
    const match = /^language-(.*)$/.exec(className || "");
    return match ? match[1] : void 0;
  }, [className]);
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(code_pane_default, __spreadProps(__spreadValues({}, rest), { language, children }));
};
...
function SpectacleLogo({ size = 100 }) {
  return /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(
    "svg",
    {
      ...
      clipRule: "evenodd",
      viewBox: "0 0 510 500",
      children: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("g", { transform: "translate(.56 -8.403)", children: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("g", { children: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("g", { children: /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("g", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("g", { transform: "translate(109.244 121.849)", children: /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("g", { fillRule: "nonzero", children: [
          /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(
            "path",
            {
              fill: "#F14E74",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("g", { transform: "translate(111.013 374.877)", children: /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("g", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(
            "path",
            {
              fill: "#FC6986",
